...
install_basic_packages() {
  local packages=(
    ...
    v4l-utils flatpak python-is-python3 ipython3 python3-pip python3-dev valac
    python3-babel python3-dbus python3-pynvim python3-sphinx python3-packaging
    libopencv-dev blueprint-compiler xss-lock transmission python3-venv thunar
    python3-xcbgen pipx xutils-dev vlc fakeroot pavucontrol lxappearance btop
...
install_dev_libs() {
  local devlibs=(
    libffi-dev libxml2-dev libegl1-mesa-dev libgles2-mesa-dev
    ...
    libncurses5-dev libreadline-dev libxrender-dev libglew-dev
